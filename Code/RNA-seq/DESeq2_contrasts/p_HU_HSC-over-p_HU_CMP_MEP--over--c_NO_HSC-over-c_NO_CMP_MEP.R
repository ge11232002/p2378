## The comparison of difference: p_HU_HSC-over-p_HU_CMP_MEP--over--c_NO_HSC-over-c_NO_CMP_MEP
...
param[['comparison']] = 'p_HU_HSC-over-p_HU_CMP_MEP--over--c_NO_HSC-over-c_NO_CMP_MEP'## ToAdapt
param[['name']] = 'p_HU_HSC-over-p_HU_CMP_MEP--over--c_NO_HSC-over-c_NO_CMP_MEP'## ToAdapt
param[['dataRoot']] = '/srv/gstore/projects'
param[['resultDir']] = 'p2378/DESeq2_35913_p_HU_MEP--over--p_HU_CMP_2019-04-23--14-21-06'
output = list()
output[['Name']] = 'p_HU_HSC-over-p_HU_CMP_MEP--over--c_NO_HSC-over-c_NO_CMP_MEP'## ToAdapt
...
colData <- colData[!colData$ind.n %in% c("3", "6", "7"), ] ## ToAdapt otherwise it complains not full rank
...
dds = DESeq(dds)
resultsNames(dds)
res = results(dds, contrast=list("grpp_HU.cndHSC", "grpc_NO.cndHSC"))
res = as.list(res)
res$sf = sf
